...
class DuplicateCardTask extends StatelessWidget {
  ...
  Widget _buildNumberOfMachines() {
    return Text(
      'Total no.of machines: ${data.numberOfMachines}',
      style: TextStyle(
          color: onPrimary,
          fontSize: 15,
          letterSpacing: 1,
  ...
  return ElevatedButton.icon(
    onPressed: () async {
      ...
      //   final newNumberofMachines = jsonData['userId']; // update this line to get the new value for numberofMachines
      //   final newData = data.copyWith(numberOfMachines: int.parse(newNumberofMachines)); // create a new DuplicateCardTaskData object with the updated value for numberofMachines
      //   // call the method to update the UI with the new data
      //   // updateUI(newData);
      // } else {
